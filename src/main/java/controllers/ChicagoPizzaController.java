...
/**
 * Controller class for the Chicago-style pizza view.
 * Handles user interactions for creating and customizing Chicago pizzas.
 *
...
public class ChicagoPizzaController {
    ...
    private void handlePizzaTypeSelection() {
        ...
        switch (selectedType) {
            case "Build your own":
                currentPizza = pizzaFactory.createBuildYourOwn();
                setImage("chicago.png");
                populateAvailableToppings();
                break;
            case "BBQ Chicken":
                currentPizza = pizzaFactory.createBBQChicken();
                setImage("chicago_bbq.png");
                populateSelectedToppingsOnly();
                break;
            case "Deluxe":
                currentPizza = pizzaFactory.createDeluxe();
                setImage("chicago_delux.png");
                populateSelectedToppingsOnly();
                break;
            case "Meatzza":
                currentPizza = pizzaFactory.createMeatzza();
                setImage("chicago_meetzza.png");
                populateSelectedToppingsOnly();
                break;
        }
